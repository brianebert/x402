...
template<> struct xdr_traits<::stellar::LedgerEntryType>
  ...
  static const std::vector<int32_t> &enum_values() {
    static const std::vector<int32_t> _xdr_enum_vec = {
      ...
      ::stellar::CONTRACT_CODE,
      ::stellar::CONFIG_SETTING,
      ::stellar::TTL
    };
    return _xdr_enum_vec;
  }
...
enum ContractDataDurability : std::int32_t {
  TEMPORARY = 0,
  PERSISTENT = 1,
};
} namespace xdr {
template<> struct xdr_traits<::stellar::ContractDataDurability>
  : xdr_integral_base<::stellar::ContractDataDurability, std::uint32_t> {
  using case_type = std::int32_t;
  static Constexpr const bool is_enum = true;
  static Constexpr const bool is_numeric = false;
  static const char *enum_name(::stellar::ContractDataDurability val) {
    switch (val) {
    case ::stellar::TEMPORARY:
      return "TEMPORARY";
    case ::stellar::PERSISTENT:
      return "PERSISTENT";
    default:
      return nullptr;
    }
...
struct ContractDataEntry {
  ...
  ContractDataEntry() = default;
  template<typename _ext_T,
           typename _contract_T,
           typename _key_T,
           typename _durability_T,
           typename _val_T,
           typename = typename
           std::enable_if<std::is_constructible<ExtensionPoint, _ext_T>::value
                          && std::is_constructible<SCAddress, _contract_T>::value
                          && std::is_constructible<SCVal, _key_T>::value
                          && std::is_constructible<ContractDataDurability, _durability_T>::value
                          && std::is_constructible<SCVal, _val_T>::value
                         >::type>
  explicit ContractDataEntry(_ext_T &&_ext,
                             _contract_T &&_contract,
                             _key_T &&_key,
                             _durability_T &&_durability,
                             _val_T &&_val)
    : ext(std::forward<_ext_T>(_ext)),
      contract(std::forward<_contract_T>(_contract)),
      key(std::forward<_key_T>(_key)),
      durability(std::forward<_durability_T>(_durability)),
      val(std::forward<_val_T>(_val)) {}
};
} namespace xdr {
template<> struct xdr_traits<::stellar::ContractDataEntry>
  : xdr_struct_base<field_ptr<::stellar::ContractDataEntry,
                              decltype(::stellar::ContractDataEntry::ext),
                              &::stellar::ContractDataEntry::ext>,
                    field_ptr<::stellar::ContractDataEntry,
                              decltype(::stellar::ContractDataEntry::contract),
                              &::stellar::ContractDataEntry::contract>,
                    field_ptr<::stellar::ContractDataEntry,
                              decltype(::stellar::ContractDataEntry::key),
                              &::stellar::ContractDataEntry::key>,
                    field_ptr<::stellar::ContractDataEntry,
                              decltype(::stellar::ContractDataEntry::durability),
                              &::stellar::ContractDataEntry::durability>,
                    field_ptr<::stellar::ContractDataEntry,
                              decltype(::stellar::ContractDataEntry::val),
                              &::stellar::ContractDataEntry::val>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::ContractDataEntry &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.contract, "contract");
    archive(ar, obj.key, "key");
    archive(ar, obj.durability, "durability");
    archive(ar, obj.val, "val");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::ContractDataEntry &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.contract, "contract");
    archive(ar, obj.key, "key");
    archive(ar, obj.durability, "durability");
...
struct ContractCodeCostInputs {
  ...
  ContractCodeCostInputs() = default;
  template<typename _ext_T,
           typename _nInstructions_T,
           typename _nFunctions_T,
           typename _nGlobals_T,
           typename _nTableEntries_T,
           typename _nTypes_T,
           typename _nDataSegments_T,
           typename _nElemSegments_T,
           typename _nImports_T,
           typename _nExports_T,
           typename _nDataSegmentBytes_T,
           typename = typename
           std::enable_if<std::is_constructible<ExtensionPoint, _ext_T>::value
                          && std::is_constructible<uint32, _nInstructions_T>::value
                          && std::is_constructible<uint32, _nFunctions_T>::value
                          && std::is_constructible<uint32, _nGlobals_T>::value
                          && std::is_constructible<uint32, _nTableEntries_T>::value
                          && std::is_constructible<uint32, _nTypes_T>::value
                          && std::is_constructible<uint32, _nDataSegments_T>::value
                          && std::is_constructible<uint32, _nElemSegments_T>::value
                          && std::is_constructible<uint32, _nImports_T>::value
                          && std::is_constructible<uint32, _nExports_T>::value
                          && std::is_constructible<uint32, _nDataSegmentBytes_T>::value
                         >::type>
  explicit ContractCodeCostInputs(_ext_T &&_ext,
                                  _nInstructions_T &&_nInstructions,
                                  _nFunctions_T &&_nFunctions,
                                  _nGlobals_T &&_nGlobals,
                                  _nTableEntries_T &&_nTableEntries,
                                  _nTypes_T &&_nTypes,
                                  _nDataSegments_T &&_nDataSegments,
                                  _nElemSegments_T &&_nElemSegments,
                                  _nImports_T &&_nImports,
                                  _nExports_T &&_nExports,
                                  _nDataSegmentBytes_T &&_nDataSegmentBytes)
    : ext(std::forward<_ext_T>(_ext)),
      nInstructions(std::forward<_nInstructions_T>(_nInstructions)),
      nFunctions(std::forward<_nFunctions_T>(_nFunctions)),
      nGlobals(std::forward<_nGlobals_T>(_nGlobals)),
      nTableEntries(std::forward<_nTableEntries_T>(_nTableEntries)),
      nTypes(std::forward<_nTypes_T>(_nTypes)),
      nDataSegments(std::forward<_nDataSegments_T>(_nDataSegments)),
      nElemSegments(std::forward<_nElemSegments_T>(_nElemSegments)),
      nImports(std::forward<_nImports_T>(_nImports)),
      nExports(std::forward<_nExports_T>(_nExports)),
      nDataSegmentBytes(std::forward<_nDataSegmentBytes_T>(_nDataSegmentBytes)) {}
};
} namespace xdr {
template<> struct xdr_traits<::stellar::ContractCodeCostInputs>
  : xdr_struct_base<field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::ext),
                              &::stellar::ContractCodeCostInputs::ext>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nInstructions),
                              &::stellar::ContractCodeCostInputs::nInstructions>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nFunctions),
                              &::stellar::ContractCodeCostInputs::nFunctions>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nGlobals),
                              &::stellar::ContractCodeCostInputs::nGlobals>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nTableEntries),
                              &::stellar::ContractCodeCostInputs::nTableEntries>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nTypes),
                              &::stellar::ContractCodeCostInputs::nTypes>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nDataSegments),
                              &::stellar::ContractCodeCostInputs::nDataSegments>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nElemSegments),
                              &::stellar::ContractCodeCostInputs::nElemSegments>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nImports),
                              &::stellar::ContractCodeCostInputs::nImports>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nExports),
                              &::stellar::ContractCodeCostInputs::nExports>,
                    field_ptr<::stellar::ContractCodeCostInputs,
                              decltype(::stellar::ContractCodeCostInputs::nDataSegmentBytes),
                              &::stellar::ContractCodeCostInputs::nDataSegmentBytes>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::ContractCodeCostInputs &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.nInstructions, "nInstructions");
    archive(ar, obj.nFunctions, "nFunctions");
    archive(ar, obj.nGlobals, "nGlobals");
    archive(ar, obj.nTableEntries, "nTableEntries");
    archive(ar, obj.nTypes, "nTypes");
    archive(ar, obj.nDataSegments, "nDataSegments");
    archive(ar, obj.nElemSegments, "nElemSegments");
    archive(ar, obj.nImports, "nImports");
    archive(ar, obj.nExports, "nExports");
    archive(ar, obj.nDataSegmentBytes, "nDataSegmentBytes");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::ContractCodeCostInputs &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.nInstructions, "nInstructions");
    archive(ar, obj.nFunctions, "nFunctions");
    archive(ar, obj.nGlobals, "nGlobals");
...
struct ContractCodeEntry {
  struct _ext_t {
    struct _v1_t {
      ...
      _v1_t() = default;
      template<typename _ext_T,
               typename _costInputs_T,
               typename = typename
               std::enable_if<std::is_constructible<ExtensionPoint, _ext_T>::value
                              && std::is_constructible<ContractCodeCostInputs, _costInputs_T>::value
                             >::type>
      explicit _v1_t(_ext_T &&_ext,
                     _costInputs_T &&_costInputs)
        : ext(std::forward<_ext_T>(_ext)),
          costInputs(std::forward<_costInputs_T>(_costInputs)) {}
    };
  ...
  template<typename _ext_T,
           ...
           std::enable_if<std::is_constructible<_ext_t, _ext_T>::value
                          ...
                          && std::is_constructible<xdr::opaque_vec<>, _code_T>::value
                         >::type>
  explicit ContractCodeEntry(_ext_T &&_ext,
                             _hash_T &&_hash,
                             _code_T &&_code)
    : ext(std::forward<_ext_T>(_ext)),
...
template<> struct xdr_traits<::stellar::ContractCodeEntry::_ext_t::_v1_t>
  : xdr_struct_base<field_ptr<::stellar::ContractCodeEntry::_ext_t::_v1_t,
                              decltype(::stellar::ContractCodeEntry::_ext_t::_v1_t::ext),
                              &::stellar::ContractCodeEntry::_ext_t::_v1_t::ext>,
                    field_ptr<::stellar::ContractCodeEntry::_ext_t::_v1_t,
                              decltype(::stellar::ContractCodeEntry::_ext_t::_v1_t::costInputs),
                              &::stellar::ContractCodeEntry::_ext_t::_v1_t::costInputs>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::ContractCodeEntry::_ext_t::_v1_t &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.costInputs, "costInputs");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::ContractCodeEntry::_ext_t::_v1_t &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.costInputs, "costInputs");
    xdr::validate(obj);
  }
};
template<> struct xdr_traits<::stellar::ContractCodeEntry::_ext_t> : xdr_traits_base {
  static Constexpr const bool is_class = true;
  static Constexpr const bool is_union = true;
  static Constexpr const bool has_fixed_size = false;

  using union_type = ::stellar::ContractCodeEntry::_ext_t;
  using case_type = ::stellar::ContractCodeEntry::_ext_t::_xdr_case_type;
  using discriminant_type = decltype(std::declval<union_type>().v());
  ...
  static std::size_t serial_size(const ::stellar::ContractCodeEntry::_ext_t &obj) {
    std::size_t size = 0;
    if (!obj._xdr_with_mem_ptr(field_size, obj._xdr_discriminant(), obj, size))
      throw xdr_bad_discriminant("bad value of v in _ext_t");
    return size + 4;
  ...
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::ContractCodeEntry::_ext_t &obj) {
    xdr::archive(ar, obj.v(), "v");
    if (!obj._xdr_with_mem_ptr(field_archiver, obj.v(), ar, obj,
                               union_field_name(obj)))
      throw xdr_bad_discriminant("bad value of v in _ext_t");
  ...
  template<typename Archive> static void
  load(Archive &ar, ::stellar::ContractCodeEntry::_ext_t &obj) {
    discriminant_type which;
    xdr::archive(ar, which, "v");
    obj.v(which);
    obj._xdr_with_mem_ptr(field_archiver, obj.v(), ar, obj,
...
template<> struct xdr_traits<::stellar::ContractCodeEntry>
  : xdr_struct_base<field_ptr<::stellar::ContractCodeEntry,
                              decltype(::stellar::ContractCodeEntry::ext),
                              &::stellar::ContractCodeEntry::ext>,
                    field_ptr<::stellar::ContractCodeEntry,
                              decltype(::stellar::ContractCodeEntry::hash),
                              &::stellar::ContractCodeEntry::hash>,
                    field_ptr<::stellar::ContractCodeEntry,
                              decltype(::stellar::ContractCodeEntry::code),
                              &::stellar::ContractCodeEntry::code>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::ContractCodeEntry &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.hash, "hash");
    archive(ar, obj.code, "code");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::ContractCodeEntry &obj) {
    archive(ar, obj.ext, "ext");
    archive(ar, obj.hash, "hash");
    archive(ar, obj.code, "code");
    xdr::validate(obj);
...
struct TTLEntry {
  ...
  TTLEntry() = default;
  template<typename _keyHash_T,
           typename _liveUntilLedgerSeq_T,
           typename = typename
           std::enable_if<std::is_constructible<Hash, _keyHash_T>::value
                          && std::is_constructible<uint32, _liveUntilLedgerSeq_T>::value
                         >::type>
  explicit TTLEntry(_keyHash_T &&_keyHash,
                    _liveUntilLedgerSeq_T &&_liveUntilLedgerSeq)
    : keyHash(std::forward<_keyHash_T>(_keyHash)),
      liveUntilLedgerSeq(std::forward<_liveUntilLedgerSeq_T>(_liveUntilLedgerSeq)) {}
};
} namespace xdr {
template<> struct xdr_traits<::stellar::TTLEntry>
  : xdr_struct_base<field_ptr<::stellar::TTLEntry,
                              decltype(::stellar::TTLEntry::keyHash),
                              &::stellar::TTLEntry::keyHash>,
                    field_ptr<::stellar::TTLEntry,
                              decltype(::stellar::TTLEntry::liveUntilLedgerSeq),
                              &::stellar::TTLEntry::liveUntilLedgerSeq>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::TTLEntry &obj) {
    archive(ar, obj.keyHash, "keyHash");
    archive(ar, obj.liveUntilLedgerSeq, "liveUntilLedgerSeq");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::TTLEntry &obj) {
    archive(ar, obj.keyHash, "keyHash");
    archive(ar, obj.liveUntilLedgerSeq, "liveUntilLedgerSeq");
    xdr::validate(obj);
  }
...
struct LedgerEntry {
  ...
  private:
    ...
    union {
      ...
      ContractDataEntry contractData_;
      ContractCodeEntry contractCode_;
      ConfigSettingEntry configSetting_;
      TTLEntry ttl_;
    };
  ...
  public:
    ...
    static Constexpr int _xdr_field_number(_xdr_case_type which) {
      return which == ACCOUNT ? 1
        ...
        : which == CONTRACT_DATA ? 7
        : which == CONTRACT_CODE ? 8
        : which == CONFIG_SETTING ? 9
        : which == TTL ? 10
        : -1;
    }
    template<typename _F, typename..._A> static bool
    _xdr_with_mem_ptr(_F &_f, _xdr_case_type _which, _A&&..._a) {
      ...
      case LIQUIDITY_POOL:
        ...
        return true;
      case CONTRACT_DATA:
        _f(&_data_t::contractData_, std::forward<_A>(_a)...);
        return true;
      case CONTRACT_CODE:
        _f(&_data_t::contractCode_, std::forward<_A>(_a)...);
        return true;
      case CONFIG_SETTING:
        _f(&_data_t::configSetting_, std::forward<_A>(_a)...);
        return true;
      case TTL:
        _f(&_data_t::ttl_, std::forward<_A>(_a)...);
        return true;
      }
      return false;
    }
    ...
    ContractDataEntry &contractData() {
      ...
      throw xdr::xdr_wrong_union("_data_t: contractData accessed when not selected");
    }
    const ContractDataEntry &contractData() const {
      if (_xdr_field_number(type_) == 7)
        return contractData_;
      throw xdr::xdr_wrong_union("_data_t: contractData accessed when not selected");
    }
    ContractCodeEntry &contractCode() {
      ...
      throw xdr::xdr_wrong_union("_data_t: contractCode accessed when not selected");
    }
    const ContractCodeEntry &contractCode() const {
      if (_xdr_field_number(type_) == 8)
        return contractCode_;
      throw xdr::xdr_wrong_union("_data_t: contractCode accessed when not selected");
    }
    ConfigSettingEntry &configSetting() {
      if (_xdr_field_number(type_) == 9)
        return configSetting_;
      throw xdr::xdr_wrong_union("_data_t: configSetting accessed when not selected");
    }
    const ConfigSettingEntry &configSetting() const {
      if (_xdr_field_number(type_) == 9)
        return configSetting_;
      throw xdr::xdr_wrong_union("_data_t: configSetting accessed when not selected");
    }
    TTLEntry &ttl() {
      if (_xdr_field_number(type_) == 10)
        return ttl_;
      throw xdr::xdr_wrong_union("_data_t: ttl accessed when not selected");
    }
    const TTLEntry &ttl() const {
      if (_xdr_field_number(type_) == 10)
        return ttl_;
      throw xdr::xdr_wrong_union("_data_t: ttl accessed when not selected");
    }
...
struct LedgerKey {
  ...
  struct _contractData_t {
    SCAddress contract{};
    SCVal key{};
    ContractDataDurability durability{};

    _contractData_t() = default;
    template<typename _contract_T,
             typename _key_T,
             typename _durability_T,
             typename = typename
             std::enable_if<std::is_constructible<SCAddress, _contract_T>::value
                            && std::is_constructible<SCVal, _key_T>::value
                            && std::is_constructible<ContractDataDurability, _durability_T>::value
                           >::type>
    explicit _contractData_t(_contract_T &&_contract,
                             _key_T &&_key,
                             _durability_T &&_durability)
      : contract(std::forward<_contract_T>(_contract)),
        key(std::forward<_key_T>(_key)),
  ...
  struct _contractCode_t {
    Hash hash{};

    _contractCode_t() = default;
    template<typename _hash_T,
             typename = typename
             std::enable_if<std::is_constructible<Hash, _hash_T>::value
                           >::type>
    explicit _contractCode_t(_hash_T &&_hash)
      : hash(std::forward<_hash_T>(_hash)) {}
  };
  struct _configSetting_t {
    ConfigSettingID configSettingID{};

    _configSetting_t() = default;
    template<typename _configSettingID_T,
             typename = typename
             std::enable_if<std::is_constructible<ConfigSettingID, _configSettingID_T>::value
                           >::type>
    explicit _configSetting_t(_configSettingID_T &&_configSettingID)
      : configSettingID(std::forward<_configSettingID_T>(_configSettingID)) {}
  };
  struct _ttl_t {
    Hash keyHash{};
    ...
    template<typename _keyHash_T,
             ...
             std::enable_if<std::is_constructible<Hash, _keyHash_T>::value
                           >::type>
    explicit _ttl_t(_keyHash_T &&_keyHash)
      : keyHash(std::forward<_keyHash_T>(_keyHash)) {}
  };
...
private:
  ...
  union {
    ...
    _contractData_t contractData_;
    _contractCode_t contractCode_;
    _configSetting_t configSetting_;
    _ttl_t ttl_;
  };
...
public:
  ...
  _xdr_with_mem_ptr(_F &_f, _xdr_case_type _which, _A&&..._a) {
    ...
    case LIQUIDITY_POOL:
      ...
      return true;
    case CONTRACT_DATA:
      _f(&LedgerKey::contractData_, std::forward<_A>(_a)...);
      return true;
    case CONTRACT_CODE:
      _f(&LedgerKey::contractCode_, std::forward<_A>(_a)...);
      return true;
    case CONFIG_SETTING:
      _f(&LedgerKey::configSetting_, std::forward<_A>(_a)...);
      return true;
    case TTL:
      _f(&LedgerKey::ttl_, std::forward<_A>(_a)...);
      return true;
    }
    return false;
  }
  ...
  _contractData_t &contractData() {
    if (_xdr_field_number(type_) == 7)
      return contractData_;
    throw xdr::xdr_wrong_union("LedgerKey: contractData accessed when not selected");
  }
  const _contractData_t &contractData() const {
    if (_xdr_field_number(type_) == 7)
      return contractData_;
    throw xdr::xdr_wrong_union("LedgerKey: contractData accessed when not selected");
  }
  _contractCode_t &contractCode() {
    if (_xdr_field_number(type_) == 8)
      return contractCode_;
    throw xdr::xdr_wrong_union("LedgerKey: contractCode accessed when not selected");
  }
  const _contractCode_t &contractCode() const {
    if (_xdr_field_number(type_) == 8)
      return contractCode_;
    throw xdr::xdr_wrong_union("LedgerKey: contractCode accessed when not selected");
  }
  _configSetting_t &configSetting() {
    if (_xdr_field_number(type_) == 9)
      return configSetting_;
    throw xdr::xdr_wrong_union("LedgerKey: configSetting accessed when not selected");
  }
  const _configSetting_t &configSetting() const {
    if (_xdr_field_number(type_) == 9)
      return configSetting_;
    throw xdr::xdr_wrong_union("LedgerKey: configSetting accessed when not selected");
  }
  _ttl_t &ttl() {
    if (_xdr_field_number(type_) == 10)
      return ttl_;
    throw xdr::xdr_wrong_union("LedgerKey: ttl accessed when not selected");
  }
  const _ttl_t &ttl() const {
    if (_xdr_field_number(type_) == 10)
      return ttl_;
    throw xdr::xdr_wrong_union("LedgerKey: ttl accessed when not selected");
  }
...
template<> struct xdr_traits<::stellar::LedgerKey::_contractData_t>
  : xdr_struct_base<field_ptr<::stellar::LedgerKey::_contractData_t,
                              decltype(::stellar::LedgerKey::_contractData_t::contract),
                              &::stellar::LedgerKey::_contractData_t::contract>,
                    field_ptr<::stellar::LedgerKey::_contractData_t,
                              decltype(::stellar::LedgerKey::_contractData_t::key),
                              &::stellar::LedgerKey::_contractData_t::key>,
                    field_ptr<::stellar::LedgerKey::_contractData_t,
                              decltype(::stellar::LedgerKey::_contractData_t::durability),
                              &::stellar::LedgerKey::_contractData_t::durability>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::LedgerKey::_contractData_t &obj) {
    archive(ar, obj.contract, "contract");
    archive(ar, obj.key, "key");
    archive(ar, obj.durability, "durability");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::LedgerKey::_contractData_t &obj) {
    archive(ar, obj.contract, "contract");
    archive(ar, obj.key, "key");
    archive(ar, obj.durability, "durability");
    xdr::validate(obj);
...
template<> struct xdr_traits<::stellar::LedgerKey::_contractCode_t>
  : xdr_struct_base<field_ptr<::stellar::LedgerKey::_contractCode_t,
                              decltype(::stellar::LedgerKey::_contractCode_t::hash),
                              &::stellar::LedgerKey::_contractCode_t::hash>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::LedgerKey::_contractCode_t &obj) {
    archive(ar, obj.hash, "hash");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::LedgerKey::_contractCode_t &obj) {
    archive(ar, obj.hash, "hash");
    xdr::validate(obj);
  }
};
template<> struct xdr_traits<::stellar::LedgerKey::_configSetting_t>
  : xdr_struct_base<field_ptr<::stellar::LedgerKey::_configSetting_t,
                              decltype(::stellar::LedgerKey::_configSetting_t::configSettingID),
                              &::stellar::LedgerKey::_configSetting_t::configSettingID>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::LedgerKey::_configSetting_t &obj) {
    archive(ar, obj.configSettingID, "configSettingID");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::LedgerKey::_configSetting_t &obj) {
    archive(ar, obj.configSettingID, "configSettingID");
    xdr::validate(obj);
  }
};
template<> struct xdr_traits<::stellar::LedgerKey::_ttl_t>
  : xdr_struct_base<field_ptr<::stellar::LedgerKey::_ttl_t,
                              decltype(::stellar::LedgerKey::_ttl_t::keyHash),
                              &::stellar::LedgerKey::_ttl_t::keyHash>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::LedgerKey::_ttl_t &obj) {
    archive(ar, obj.keyHash, "keyHash");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::LedgerKey::_ttl_t &obj) {
    archive(ar, obj.keyHash, "keyHash");
    xdr::validate(obj);
  }
};
...
template<> struct xdr_traits<::stellar::EnvelopeType>
  ...
  static const char *enum_name(::stellar::EnvelopeType val) {
    ...
    case ::stellar::ENVELOPE_TYPE_CONTRACT_ID:
      return "ENVELOPE_TYPE_CONTRACT_ID";
    case ::stellar::ENVELOPE_TYPE_SOROBAN_AUTHORIZATION:
  ...
  static const std::vector<int32_t> &enum_values() {
    static const std::vector<int32_t> _xdr_enum_vec = {
      ...
      ::stellar::ENVELOPE_TYPE_CONTRACT_ID,
      ::stellar::ENVELOPE_TYPE_SOROBAN_AUTHORIZATION
    };
    return _xdr_enum_vec;
  }
};
...
enum BucketListType : std::int32_t {
  LIVE = 0,
  HOT_ARCHIVE = 1,
};
} namespace xdr {
template<> struct xdr_traits<::stellar::BucketListType>
  : xdr_integral_base<::stellar::BucketListType, std::uint32_t> {
  using case_type = std::int32_t;
  static Constexpr const bool is_enum = true;
  static Constexpr const bool is_numeric = false;
  static const char *enum_name(::stellar::BucketListType val) {
    switch (val) {
    case ::stellar::LIVE:
      return "LIVE";
    case ::stellar::HOT_ARCHIVE:
      return "HOT_ARCHIVE";
    default:
      return nullptr;
    }
...
enum HotArchiveBucketEntryType : std::int32_t {
  HOT_ARCHIVE_METAENTRY = -1,
  HOT_ARCHIVE_ARCHIVED = 0,
  HOT_ARCHIVE_LIVE = 1,
};
} namespace xdr {
template<> struct xdr_traits<::stellar::HotArchiveBucketEntryType>
  : xdr_integral_base<::stellar::HotArchiveBucketEntryType, std::uint32_t> {
  using case_type = std::int32_t;
  static Constexpr const bool is_enum = true;
  static Constexpr const bool is_numeric = false;
  static const char *enum_name(::stellar::HotArchiveBucketEntryType val) {
    switch (val) {
    case ::stellar::HOT_ARCHIVE_METAENTRY:
      return "HOT_ARCHIVE_METAENTRY";
    case ::stellar::HOT_ARCHIVE_ARCHIVED:
      return "HOT_ARCHIVE_ARCHIVED";
    case ::stellar::HOT_ARCHIVE_LIVE:
  ...
  static const std::vector<int32_t> &enum_values() {
    static const std::vector<int32_t> _xdr_enum_vec = {
      ::stellar::HOT_ARCHIVE_METAENTRY,
      ::stellar::HOT_ARCHIVE_ARCHIVED,
      ::stellar::HOT_ARCHIVE_LIVE
    };
    return _xdr_enum_vec;
  }
};
...
struct BucketMetadata {
  ...
  private:
    _xdr_case_type v_;
    union {
      BucketListType bucketListType_;
    };
  ...
  public:
    ...
    _xdr_with_mem_ptr(_F &_f, _xdr_case_type _which, _A&&..._a) {
      ...
      case 0:
        return true;
      case 1:
        _f(&_ext_t::bucketListType_, std::forward<_A>(_a)...);
        return true;
      }
      return false;
    }
    ...
    BucketListType &bucketListType() {
      if (_xdr_field_number(v_) == 1)
        return bucketListType_;
      throw xdr::xdr_wrong_union("_ext_t: bucketListType accessed when not selected");
    }
    const BucketListType &bucketListType() const {
      if (_xdr_field_number(v_) == 1)
        return bucketListType_;
      throw xdr::xdr_wrong_union("_ext_t: bucketListType accessed when not selected");
    }
...
struct HotArchiveBucketEntry {
  using _xdr_case_type = xdr::xdr_traits<HotArchiveBucketEntryType>::case_type;
private:
  _xdr_case_type type_;
  union {
    LedgerEntry archivedEntry_;
    LedgerKey key_;
    BucketMetadata metaEntry_;
  };
...
public:
  static Constexpr const bool _xdr_has_default_case = false;
  static const std::vector<HotArchiveBucketEntryType> &_xdr_case_values() {
    static const std::vector<HotArchiveBucketEntryType> _xdr_disc_vec {
  ...
  static Constexpr int _xdr_field_number(_xdr_case_type which) {
    return which == HOT_ARCHIVE_ARCHIVED ? 1
      : which == HOT_ARCHIVE_LIVE ? 2
      : which == HOT_ARCHIVE_METAENTRY ? 3
      : -1;
  }
  template<typename _F, typename..._A> static bool
  _xdr_with_mem_ptr(_F &_f, _xdr_case_type _which, _A&&..._a) {
    ...
    case HOT_ARCHIVE_ARCHIVED:
      _f(&HotArchiveBucketEntry::archivedEntry_, std::forward<_A>(_a)...);
      return true;
    case HOT_ARCHIVE_LIVE:
      _f(&HotArchiveBucketEntry::key_, std::forward<_A>(_a)...);
      return true;
    case HOT_ARCHIVE_METAENTRY:
      _f(&HotArchiveBucketEntry::metaEntry_, std::forward<_A>(_a)...);
      return true;
    }
    return false;
  }
  ...
  void _xdr_discriminant(_xdr_case_type which, bool validate = true) {
    int fnum = _xdr_field_number(which);
    if (fnum < 0 && validate)
      throw xdr::xdr_bad_discriminant("bad value of type in HotArchiveBucketEntry");
    if (fnum != _xdr_field_number(type_)) {
      this->~HotArchiveBucketEntry();
      type_ = which;
      _xdr_with_mem_ptr(xdr::field_constructor, type_, *this);
    }
    else
  ...
  explicit HotArchiveBucketEntry(HotArchiveBucketEntryType which = HotArchiveBucketEntryType{}) : type_(which) {
    _xdr_with_mem_ptr(xdr::field_constructor, type_, *this);
  }
  HotArchiveBucketEntry(const HotArchiveBucketEntry &source) : type_(source.type_) {
    _xdr_with_mem_ptr(xdr::field_constructor, type_, *this, source);
  }
  HotArchiveBucketEntry(HotArchiveBucketEntry &&source) : type_(source.type_) {
    _xdr_with_mem_ptr(xdr::field_constructor, type_, *this,
                      std::move(source));
  }
  ~HotArchiveBucketEntry() { _xdr_with_mem_ptr(xdr::field_destructor, type_, *this); }
  HotArchiveBucketEntry &operator=(const HotArchiveBucketEntry &source) {
    if (_xdr_field_number(type_)
        == _xdr_field_number(source.type_))
      _xdr_with_mem_ptr(xdr::field_assigner, type_, *this, source);
    else {
  ...
  HotArchiveBucketEntry &operator=(HotArchiveBucketEntry &&source) {
    if (_xdr_field_number(type_)
         == _xdr_field_number(source.type_))
      _xdr_with_mem_ptr(xdr::field_assigner, type_, *this,
                        std::move(source));
  ...
  HotArchiveBucketEntryType type() const { return HotArchiveBucketEntryType(type_); }
  HotArchiveBucketEntry &type(HotArchiveBucketEntryType _xdr_d, bool _xdr_validate = true) {
    _xdr_discriminant(_xdr_d, _xdr_validate);
    return *this;
  }
  ...
  LedgerEntry &archivedEntry() {
    if (_xdr_field_number(type_) == 1)
      return archivedEntry_;
    throw xdr::xdr_wrong_union("HotArchiveBucketEntry: archivedEntry accessed when not selected");
  }
  const LedgerEntry &archivedEntry() const {
    if (_xdr_field_number(type_) == 1)
      return archivedEntry_;
    throw xdr::xdr_wrong_union("HotArchiveBucketEntry: archivedEntry accessed when not selected");
  }
  LedgerKey &key() {
    if (_xdr_field_number(type_) == 2)
      return key_;
    throw xdr::xdr_wrong_union("HotArchiveBucketEntry: key accessed when not selected");
  }
  const LedgerKey &key() const {
    if (_xdr_field_number(type_) == 2)
      return key_;
    throw xdr::xdr_wrong_union("HotArchiveBucketEntry: key accessed when not selected");
  }
  BucketMetadata &metaEntry() {
    if (_xdr_field_number(type_) == 3)
      return metaEntry_;
    throw xdr::xdr_wrong_union("HotArchiveBucketEntry: metaEntry accessed when not selected");
  }
  const BucketMetadata &metaEntry() const {
    if (_xdr_field_number(type_) == 3)
      return metaEntry_;
...
template<> struct xdr_traits<::stellar::HotArchiveBucketEntry> : xdr_traits_base {
  static Constexpr const bool is_class = true;
  static Constexpr const bool is_union = true;
  static Constexpr const bool has_fixed_size = false;

  using union_type = ::stellar::HotArchiveBucketEntry;
  using case_type = ::stellar::HotArchiveBucketEntry::_xdr_case_type;
  using discriminant_type = decltype(std::declval<union_type>().type());
  ...
  static std::size_t serial_size(const ::stellar::HotArchiveBucketEntry &obj) {
    std::size_t size = 0;
    if (!obj._xdr_with_mem_ptr(field_size, obj._xdr_discriminant(), obj, size))
      throw xdr_bad_discriminant("bad value of type in HotArchiveBucketEntry");
    return size + 4;
  }
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::HotArchiveBucketEntry &obj) {
    xdr::archive(ar, obj.type(), "type");
    if (!obj._xdr_with_mem_ptr(field_archiver, obj.type(), ar, obj,
                               union_field_name(obj)))
      throw xdr_bad_discriminant("bad value of type in HotArchiveBucketEntry");
  ...
  template<typename Archive> static void
  load(Archive &ar, ::stellar::HotArchiveBucketEntry &obj) {
    discriminant_type which;
    xdr::archive(ar, which, "type");
    obj.type(which);
    obj._xdr_with_mem_ptr(field_archiver, obj.type(), ar, obj,
