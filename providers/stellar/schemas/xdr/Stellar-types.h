...
struct ShortHashSeed {
  xdr::opaque_array<16> seed{};

  ShortHashSeed() = default;
  template<typename _seed_T,
           typename = typename
           std::enable_if<std::is_constructible<xdr::opaque_array<16>, _seed_T>::value
                         >::type>
  explicit ShortHashSeed(_seed_T &&_seed)
    : seed(std::forward<_seed_T>(_seed)) {}
};
} namespace xdr {
template<> struct xdr_traits<::stellar::ShortHashSeed>
  : xdr_struct_base<field_ptr<::stellar::ShortHashSeed,
                              decltype(::stellar::ShortHashSeed::seed),
                              &::stellar::ShortHashSeed::seed>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::ShortHashSeed &obj) {
    archive(ar, obj.seed, "seed");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::ShortHashSeed &obj) {
    archive(ar, obj.seed, "seed");
    xdr::validate(obj);
  }
};
...
enum BinaryFuseFilterType : std::int32_t {
  BINARY_FUSE_FILTER_8_BIT = 0,
  BINARY_FUSE_FILTER_16_BIT = 1,
  BINARY_FUSE_FILTER_32_BIT = 2,
};
} namespace xdr {
template<> struct xdr_traits<::stellar::BinaryFuseFilterType>
  : xdr_integral_base<::stellar::BinaryFuseFilterType, std::uint32_t> {
  using case_type = std::int32_t;
  static Constexpr const bool is_enum = true;
  static Constexpr const bool is_numeric = false;
  static const char *enum_name(::stellar::BinaryFuseFilterType val) {
    switch (val) {
    case ::stellar::BINARY_FUSE_FILTER_8_BIT:
      return "BINARY_FUSE_FILTER_8_BIT";
    case ::stellar::BINARY_FUSE_FILTER_16_BIT:
      return "BINARY_FUSE_FILTER_16_BIT";
    case ::stellar::BINARY_FUSE_FILTER_32_BIT:
  ...
  static const std::vector<int32_t> &enum_values() {
    static const std::vector<int32_t> _xdr_enum_vec = {
      ::stellar::BINARY_FUSE_FILTER_8_BIT,
      ::stellar::BINARY_FUSE_FILTER_16_BIT,
      ::stellar::BINARY_FUSE_FILTER_32_BIT
    };
    return _xdr_enum_vec;
  }
};
...
struct SerializedBinaryFuseFilter {
  ...
  xdr::opaque_vec<> fingerprints{};

  SerializedBinaryFuseFilter() = default;
  template<typename _type_T,
           typename _inputHashSeed_T,
           typename _filterSeed_T,
           typename _segmentLength_T,
           typename _segementLengthMask_T,
           typename _segmentCount_T,
           typename _segmentCountLength_T,
           typename _fingerprintLength_T,
           typename _fingerprints_T,
           typename = typename
           std::enable_if<std::is_constructible<BinaryFuseFilterType, _type_T>::value
                          && std::is_constructible<ShortHashSeed, _inputHashSeed_T>::value
                          && std::is_constructible<ShortHashSeed, _filterSeed_T>::value
                          && std::is_constructible<uint32, _segmentLength_T>::value
                          && std::is_constructible<uint32, _segementLengthMask_T>::value
                          && std::is_constructible<uint32, _segmentCount_T>::value
                          && std::is_constructible<uint32, _segmentCountLength_T>::value
                          && std::is_constructible<uint32, _fingerprintLength_T>::value
                          && std::is_constructible<xdr::opaque_vec<>, _fingerprints_T>::value
                         >::type>
  explicit SerializedBinaryFuseFilter(_type_T &&_type,
                                      _inputHashSeed_T &&_inputHashSeed,
                                      _filterSeed_T &&_filterSeed,
                                      _segmentLength_T &&_segmentLength,
                                      _segementLengthMask_T &&_segementLengthMask,
                                      _segmentCount_T &&_segmentCount,
                                      _segmentCountLength_T &&_segmentCountLength,
                                      _fingerprintLength_T &&_fingerprintLength,
                                      _fingerprints_T &&_fingerprints)
    : type(std::forward<_type_T>(_type)),
      inputHashSeed(std::forward<_inputHashSeed_T>(_inputHashSeed)),
      filterSeed(std::forward<_filterSeed_T>(_filterSeed)),
      segmentLength(std::forward<_segmentLength_T>(_segmentLength)),
      segementLengthMask(std::forward<_segementLengthMask_T>(_segementLengthMask)),
      segmentCount(std::forward<_segmentCount_T>(_segmentCount)),
      segmentCountLength(std::forward<_segmentCountLength_T>(_segmentCountLength)),
      fingerprintLength(std::forward<_fingerprintLength_T>(_fingerprintLength)),
      fingerprints(std::forward<_fingerprints_T>(_fingerprints)) {}
};
} namespace xdr {
template<> struct xdr_traits<::stellar::SerializedBinaryFuseFilter>
  : xdr_struct_base<field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::type),
                              &::stellar::SerializedBinaryFuseFilter::type>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::inputHashSeed),
                              &::stellar::SerializedBinaryFuseFilter::inputHashSeed>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::filterSeed),
                              &::stellar::SerializedBinaryFuseFilter::filterSeed>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::segmentLength),
                              &::stellar::SerializedBinaryFuseFilter::segmentLength>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::segementLengthMask),
                              &::stellar::SerializedBinaryFuseFilter::segementLengthMask>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::segmentCount),
                              &::stellar::SerializedBinaryFuseFilter::segmentCount>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::segmentCountLength),
                              &::stellar::SerializedBinaryFuseFilter::segmentCountLength>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::fingerprintLength),
                              &::stellar::SerializedBinaryFuseFilter::fingerprintLength>,
                    field_ptr<::stellar::SerializedBinaryFuseFilter,
                              decltype(::stellar::SerializedBinaryFuseFilter::fingerprints),
                              &::stellar::SerializedBinaryFuseFilter::fingerprints>> {
  template<typename Archive> static void
  save(Archive &ar, const ::stellar::SerializedBinaryFuseFilter &obj) {
    archive(ar, obj.type, "type");
    archive(ar, obj.inputHashSeed, "inputHashSeed");
    archive(ar, obj.filterSeed, "filterSeed");
    archive(ar, obj.segmentLength, "segmentLength");
    archive(ar, obj.segementLengthMask, "segementLengthMask");
    archive(ar, obj.segmentCount, "segmentCount");
    archive(ar, obj.segmentCountLength, "segmentCountLength");
    archive(ar, obj.fingerprintLength, "fingerprintLength");
    archive(ar, obj.fingerprints, "fingerprints");
  }
  template<typename Archive> static void
  load(Archive &ar, ::stellar::SerializedBinaryFuseFilter &obj) {
    archive(ar, obj.type, "type");
    archive(ar, obj.inputHashSeed, "inputHashSeed");
    archive(ar, obj.filterSeed, "filterSeed");
    archive(ar, obj.segmentLength, "segmentLength");
